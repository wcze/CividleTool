const EN = {
   ...
   Atomium: "Atomium",
   AtomiumDescV2: "All buildings that produce science (except Clone Labs) within 2 tile range get +5 Production Multiplier. Generate science that is equal to the science production within 2 tile range of Atomium. When completed, generate one-time science equivalent to the cost of the most expensive unlocked technology",
   ...
   BecomeAllyTooltipV2: "To become an ally with your neighbor, play the same civilization",
   ...
   BranCastleDescV2: "Produce X workers. X = workers produced within 3 tile range. If there are enough workers, will also employ X workers. Vampires don't produce or transport resources but are counted workers. Bran Castle's level is determined by total workers and each level provides +1 Science Per Idle Worker and +2 Science Per Busy Worker. This wonder can only be constructed during Halloween (10.15 ~ 11.15)",
   ...
   Carnival: "Carnival, Giant Otter, Hoatzin and Royal Flycatcher's range is increased to 3 tiles. Double the production multiplier from Cathedral of Brasília",
   ...
   FirstTimeTutorialWelcome2HTML: "Buildings can be upgraded - it costs resources and takes time. When a building is being upgraded, <b>it will no longer produce</b>. This includes buildings that provide workers, <b>so never upgrade all your buildings at the same time!</b><br><br>As your empire grows, you will get more science and unlock new technologies. I will tell you more about it when we get there but you can go to View -> Research to take a quick look<br><br>",
   FirstTimeTutorialWelcome3HTML: "Now you know all the basics of the game, you can start building your empire. But before I let you go, you should <b>choose yourself a player handle</b> and say hi in the in-game chat. We have an amazingly helpful community, don't be afraid to ask!",
   ...
   IdeologyDescHTML: "Choose from <b>Liberalism, Conservatism, Socialism or Communism</b> empire ideology for this rebirth. You <b>cannot switch ideology</b> after it is chosen. You can unlock more boost within each ideology",
   IMPei: "I. M. Pei",
   ...
   MoveBuildingSelectTileToastHTML: "Select <b>an empty explored tile</b> on the map target",
   ...
   Neighbor: "Neighbor",
   Neighbors: "Neighbors",
   NeighborsDescHTMLV2: "You get <b>+%{neighbor} Production Multiplier</b> for each neighbor's tile, and <b>+%{ally} Production Multiplier</b> for each ally's tile. To become an ally with your neighbor, play the same civilization",
   ...
   PlayerMapTariffDesc: "Every trade that goes through your tile will pay a tariff to you. It's a balance, the more you will gain from each trade, but fewer trades will go through your tile.",
   ...
   PorcelainTowerDescV2: "+5 Happiness, plus +1 Happiness for each additional level. When constructed, all Extra Great People earned at Rebirth become available for this run, following the same roll rules Great People",
   ...
   ReligionDescHTML: "Choose from <b>Christianity, Islam, Buddhism or Polytheism</b> empire religion for this rebirth. You <b>cannot switch religion</b> after it is chosen. You can unlock more boosts by upgrading",
   ReligionIslam: "Islam",
   ...
   SpinnerSpeedDescHTML: "Set the speed for normal buildings. Electrified buildings spin twice. <b>Must be between 0.01 and 100. Default is 1</b>",
   Sports: "Sports",
   Sputnik1: "Sputnik 1",
   Sputnik1DescV3: "This wonder can be upgraded and each level provides +1 level to all Cold War Age great people for this run (excl. Great People that provide level boost) and +1 Production, Storage Multiplier to Cosmodrome. Provides +1 Production and Storage Multiplier to Cosmodrome for each level of Cold War Age Wisdom",
   Stable: "Stable",
   Stadium: "Stadium",
   ...
   SuperintelligenceDesc: "After constructing this wonder, Superintelligence can be researched, which costs 2X science and carries over X science to your next run. X = total science to unlock the whole tech tree",
   ...
   SwissBankDescV3: "Convert a chosen resource from player tradeable resources (currently in a Caravansary or a Warehouse adjacent to one) to Koti (10 million in Sanskrit). Each level of Swiss Bank adds 1 Koti conversion per cycle, which is affected by Production Multiplier. Swiss Bank can store an unlimited amount of Koti",
   Sword: "Sword",
   ...
   TerryFox: "Terry Fox",
   Thanksgiving: "Thanksgiving, Hedge Fund and Bitcoin Miner, and +5 Production Multiplier to Research Funds",
   ...
   TraditionDescHTML: "Choose from <b>Cultivation, Commerce, Expansion or Honor</b> empire tradition for this rebirth. You <b>cannot switch tradition</b> after it is chosen. You can unlock more boosts by upgrading",
   ...
   TutorialBuildStatisticsOfficeHTML: "Counting tech unlocks <b>Statistics Office</b>, which is a wonder - you can only build one and it cannot be demolished. You don't have to have all the resources before starting the construction - will gradually be transported to the construction site. Statistics Office provides useful statistics of your empire and generates explorers to help exploring the map.",
   ...
   TutorialResearchCountingHTML: "To research a tech, click on <b>Research</b> tab, select the tech you want to research and click <b>Unlock</b> on the right side panel. If you don't have enough science, you can keep on upgrading your huts busy workers will generate more science.",
   TutorialResearchHousingHTML: "Researching Housing tech to unlock <b>House</b>, which provides more workers than huts. After researching Housing, your empire will enter <b>Bronze Age</b>, and a Bronze Age great person will be born. You can choose one from three choices - a great person provides significant boost - choose wisely.",
   ...
   TutorialUpgrade35LevelsHTML: "When upgrading buildings, you can click <b>~5</b> to upgrade to the next 5 levels. You can also adjust the target level in the right side panel while the building is being upgraded. Upgrading a building will increase its production and <b>storage</b>. A building has limited storage and will no longer produce when it's full.",
