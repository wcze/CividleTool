const ZH_CN = {
   ...
   AdvisorStorageContent: "尽管建筑有许多存储空间，但仍会填满，若长时间闲置尤为如此。<b>建筑存满，不再生产。</b>这并不总是问题，毕竟建筑存储已满意味着拥有大量库存，只不过通常而言，保持持续生产更好。<br><br>通过仓库是一种调节方式。当你建造完成一座仓库，你将获得一份当前已发现的所有产物的名单，你可以设定仓库调用任意数量的任何产出，前提是所有产���的总量在仓库的调用范围内，而这一范围基于仓库等级与存储乘数。<br><br>设定一座仓库的简单方法，那就是勾选你想运入仓库的每种产出，然后使用“在选定对象中重新分配”来均分运输量与限额。如果你希望建筑也能从仓库调用资源，那也请确保打开“低于限额仍输出”功能。",
   ...
   AdvisorWonderContent: "奇观是特殊建筑，它们可以提供全局效果，这将在你的游戏中产生深远影响。除了它们列出的功能，所有奇观还都能提供 +1 幸福感。你需要深思熟虑，因为<b>建造奇观��要大量资源，并且其建造者能力也高于正常水平。</b>这意味着它们可以轻易耗尽你库存中的需求资源，使得你的其它建筑缺少原料。<b>你可以自由设定每种资源是否运输</b>，这使你可以在你的库存资源能确保一切运转的状态下建造奇观。",
   ...
   Agamemnon: "阿伽门农",
   AgeWisdom: "时代智慧",
   AgeWisdomDescHTML: "时代智慧可为相同时代且具备资质的永恒伟人赋予<b>等同于智慧等级</b>加成效果——它可使用相同时代且具备资质的���恒伟人碎片升级",
   ...
   Alcohol: "酒",
   AldersonDisk: "奥尔德森碟",
   AldersonDiskDesc: "+25 幸福感。该奇观可被升级，并且每一次��外升级，提供 +5 幸福感",
   Alloy: "合金",
   ...
   AtlasMountainsDesc: "周围 2 地块范围内的���有建筑获得 +N 生产乘数。 N 为该奇观范围内建筑生产但未被范围内建筑消耗的不相同资源种类",
   AtomicBomb: "原子弹",
   AtomicFacility: "原子设施",
   AtomicTheory: "原子理论",
   Atomium: "原子塔",
   ...
   CentrePompidouDesc: "建造完成后，所有建筑获得 +1 生产乘数和 +2 存储乘数。对于每次游玩该奇观未记录的文明达到信息时代后，在重���时记录重生前的文明，每拥有一个记录在册的文明额外提供 +1 生产乘数和 +2 存储乘数。该奇观的价值不计入帝国的总价值中。如果当前的游玩达到信息时代，下一次游玩的文明与当前是不同的，那么该奇观可被继承！",
   CentrePompidouWarningHTML: "蓬皮杜国家艺术和文化中心将消失，如果你重生在 <b>%{civ}</b>",
   ...
   ChateauFrontenacDesc: "该奇观可被升级，每次升级时，将随机抽取三种当前时代的建��。选择其中一种建筑来获得 +1 生产等级（一旦选择了就不能改变）",
   ...
   CursorStyle: "光标类型",
   CursorStyleDescHTML: "改变光标类型。<b>需重��游戏以生效</b>",
   CursorSystem: "系统",
   Cycle: "周期",
   CyrusII: "居鲁士二世",
   DairyFarm: "奶牛场",
   ...
   DestroyAllResourcesContent: "你确定要毁掉该建筑���的所有资源吗？这项操作不能撤回！",
   ...
   EachPairOfAdjacentPaintingsWithTheSameTheme: "每���邻相同主题的画作获得 +5 建造者能力乘数",
   EasterBunny: "复活节兔子",
   ...
   FirstTimeTutorialWelcome2HTML: "建筑可以进行升级——这需要花费资源以及一些时间。当一座建筑处于升级中的状态，<b>它将不再生产</b>。这包括了生产劳动者的建筑，<b>所以永远不要同时升级你的所��建筑！</b><br><br>随着你帝国的发展，你将获得更多科学并以此解锁新的科技。当我们到那儿时，开发者将告诉你更多相关信息，但你可以前往“视图”→“研究”快速查看一下。<br><br>",
   ...
   GoldenPavilion: "金阁寺",
   GoldenPavilionDesc: "周围 3 地块范围内的所有建筑，A 建筑相邻 B 建筑，且 B 生产是 A 消耗任意所需，则 A 建筑获得 +1 生产乘��（克隆实验室与克隆工厂除外,需建筑都运转。例：石雕铺相邻 3 个工匠铺，则石雕铺获得 +3 生产乘数）",
   GoldMiningCamp: "金矿",
   GordonMoore: "戈登·摩尔",
   ...
   HappinessFromHighestTierBuilding: "来自最高阶的工作建���",
   ...
   IdeologyDescHTML: "使用<b>鼠标滚轮或右边的滚动条</b>，从<b>自由主义、保守主义、社会主义以及共产主义</b>中选择一种作为你的帝国意识形态。一旦选择，你将<b>不能更换意识形态</b>。每种意识形态，你都能解锁更多增强",
   IMPei: "贝聿铭",
   ...
   Islam5UpgradeHTML: "解��时，生成一批科学，生成量(<b>76.97B</b>)等同于<b>工业时代</b>最昂贵科技所需",
   ...
   OnYourSpecialDayDesc: "在您的特别日里，所有玩家的所有建筑获得 +1 生产乘数和 +1 生产等级。你的特别日将会会显示在游戏���历上。<b>此效果每 %{cooldown} 天只能更改一次。</b>",
   OpenGallery: "打开画廊",
   ...
   Petra: "佩特拉",
   PetraDescV3: "解锁更多扭曲倍速和扭曲时间继承。该奇观可以升级，每一级提供 1 小时的扭曲存储。当你离线时生成扭曲时间，你可以用来加速你的帝国或携带最多 4 小时（14.4K）扭曲时间到重生后的地图（可在右上角的选项-游戏设置-离线生产栏里分配离线设置）",
   ...
   RebirthTime: "重生时间",
   Reborn: "重生",
   RebornModalDescV3: "你将开始一座新的帝国，但你的所有<b>此生</b>伟人将成为永恒碎片，���片可用来升级你的<b>永恒伟人等级</b>。你也可以获得额外伟人碎片，这基于你的<b>帝国总价值</b>",
   ...
   ReligionDescHTML: "使用<b>鼠标滚轮或右边的滚动条</b>，从<b>基督教、伊斯兰教、佛教以及多神教</b>中选择一种作为你的帝国宗教。一旦选择，你将<b>不能更换宗教</b>。每种宗教，你都能解锁更多增强",
   ...
   TutorialHappinessHTML: "建造新建筑需要消耗幸福感，当你的幸福感低于0时，你的可用劳动者就会减少。-50幸福感会导致你的帝国完全停止，所以不要过度扩张你的帝国。你可以通过点击��部面板上的幸福图标来查看幸福指数。",
