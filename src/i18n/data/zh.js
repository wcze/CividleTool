const ZH_CN = {
   ...
   BranCastle: "布朗城堡",
   BranCastleDescV2:
      "该奇观产出的劳动者等同于周围 3 地块范围内的劳动者总产出。如果有足够的劳动者，还会将该奇观产出的劳动者转化为吸血鬼。吸血鬼不参与生产或运输资源，但被视为忙碌的劳动者。布郎城堡的等级由劳动者总数决定，每一级获得 +1 闲置劳动者科学产出和 +2 忙碌劳动者科学产出。该奇观仅可在万圣节（10月15日至11月15日）期间建造。",
   ...
   BritishMuseumDesc: "建造完成后，可以变更为其他文明的奇观（蓬皮杜文艺中心、巨港、莫瑞泰斯皇家美术馆以及自然奇观除外。仅有一次变更机会，请慎重考虑）",
   ...
   CathedralOfBrasiliaDesc:
      "如果周围 2 地块范围的每个建筑形成一个完整的生产链，即范围内一个建筑生产的资源被范围内另一个建筑消耗（范围当中相同产出不同建筑也会被归入完整的生产链中），那么参入该完整的生产链中的每种建筑为其所有相同建筑提供 +X 生产乘数。X 为生产链中不相同建筑数量（最大值为18。奇观、旅馆、仓库、市集、克隆工厂和克隆实验室除外）",
   CathedralOfBrasiliaWarningHTML: "为了形成生产链，一个建筑生产的资源除了一种资源外（只能一种资源产出没被✅），其他所有资源都需要被另一个建筑消耗。（奇观、旅馆、仓库、市集、克隆工厂和克隆实验室除外）",
   Census: "劳动者统计",
   CentrePompidou: "蓬皮杜（Pompidou）文艺中心",
   CentrePompidouDesc:
      "建造完成后，所有建筑获得 +1 生产乘数和 +2 存储乘数。对于每次游玩该奇观未记录的文明达到信息时代后，在重生时记录重生前的文明，每拥有一个记录在册的文明额外提供 +1 生产乘数和 +2 存储乘数。如果当前的游玩达到信息时代，下一次游玩是不同的文明，那么该奇观可被继承！该奇观的价值不计入帝国的总价值中，大英博物馆无法变更为该奇观。",
   ...
   EastIndiaCompanyDescV2: "当您通过贸易获得的所有物品都会获得相应贸易点数（包括税收，物品的每 1 价值 = 1 贸易点数）。该奇观累积您获得的贸易点数。每周期自动消耗 2000 贸易点数, 使所有建筑每相邻一个运转的商队旅馆获得 +0.5 生产乘数。该奇观可消耗贸易点数进行升级，并且每一次额外升级获得 +0.5 生产乘数",
   Education: "教育学",
   ...
   Literature: "文学",
   LiveData: "实时数据",
   LockTradeProfit: "锁定贸易利润率（发出订单者的收益）",
