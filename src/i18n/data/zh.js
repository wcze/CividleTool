const ZH_CN = {
   About: "关于放置文明",
   AbuSimbel: "阿布辛贝神庙",
   AbuSimbelDescV2: "每一级 +100% 拉美西斯二世（青铜时代，建造者能力）的效果（此生伟人与永恒伟人的效果。时代智慧除外）。为周围 1 块地范围内的所有奇观额外提供 +1 幸福感。该奇观可被升级，并且每一次额外升级为奇观周围扩大 1 地块范围。",
   AccountActiveTrade: "活跃中的订单",
   ...
   Acknowledge: "收到",
   Acropolis: "雅典卫城",
   AcropoliumOfCarthage: "迦太基—圣路易大教堂",
   ActorsGuild: "演员协会",
   ...
   AdjacencyBonus: "展览相邻奖励",
   AdjustBuildingCapacity: "生产能力",
   AdvisorElectricityContentV2: "产出电能的建筑为你提供了两个新系统。首先，发电厂相邻地块的闪电标识表示“电力”。一些建筑（如世界大战的解锁建筑广播站）在具体的科技与建筑界面中，有“需要电力”的提示。<b>这意味着它们必须建在含闪电标识的地块上，才能正常运转。</b>需要电力且已被提供电力的建筑，也能将电力扩散至其相邻地块，所以只要至少有一座需要电力的建筑与产出电能的建筑相邻，你就可以使需要电力的建筑相互提供电力。<br><br>另一个系统“现代化改造”可被应用于地图上<b>任何地块的任何建筑</b>，前提是它不产出科学也不生产劳动者。这将使用产出电能的建筑产出的电能，从而增加建筑的生产等级（提供的生产等级——其将不会影响劳动者与存储）。越高的现代化改造等级，需求的电能将会越来越多。相较于其它建筑，“需要电力”的建筑可以从现代化改造中额外获得 +5 生产等级。",
   AdvisorElectricityTitle: "电能：电力与现代化改造",
   AdvisorGreatPeopleContent: "每当你进入一个科技新时代，你将能选择一位当前时代伟人，之前每个时代也都能再选择一位。这些伟人带来全局加成，诸如增加生产、科学、幸福感以及许多其它方面。<br><br>这些加成在重生前一直保有。当你选择重生后，所有这些伟人将成为永恒伟人，他们的加成也将永久存在。<br><br>在一轮中选择一位相同的伟人，将叠加加成。若你重生并拥有重复伟人，重复项将被存储并可被用来升级永恒伟人。这项功能在你总部建筑内的<b>管理永恒伟人</b>界面中使用。",
   AdvisorGreatPeopleTitle: "伟人",
   AdvisorHappinessContent: "幸福感是放置文明中限制扩张的核心机制。你可以通过解锁新科技、进入新时代、建造奇观、获取提供幸福感的伟人以及你在学习中发现的一些其它方式来获得幸福感。<b>每座新建筑消耗 1 幸福感。</b>超过/低于 0 幸福感，每点幸福感将给你的劳动者总数带来 2% 的加成或减益（生效幸福感区间为 [ -50 ，50 ] ）。你可以在<b>总部建筑的幸福感部分</b>查看幸福感的详细分类。",
   AdvisorHappinessTitle: "维持劳动者幸福",
   AdvisorOkay: "明白了，谢谢！",
   AdvisorScienceContent: "你的忙碌劳动者产出科学，这将允许你解锁新的科技以及推动你的文明发展。你有许多方式进入研究界面，比如点击科学计量表（资源栏）、查看你的总部建筑中你的可解锁科技或者使用“视图”菜单，这些都将展开以科技树为主体的研究界面。研究界面为你展示了所有科技，以及每项科技解锁需求的科学等。如果你有足够的科学用来学习一项新科技，只需单击目标科技再单击侧边栏的“解锁”即可。<b>每一新阶与时代之科技需求的科学不断增加，但你也将解锁新的、更好的方式以获得科学。</b>",
   AdvisorScienceTitle: "科学发现！",
   AdvisorSkipAllTutorials: "跳过所有教程",
   AdvisorStorageContent: "尽管建筑有许多存储空间，但仍会填满，若长时间闲置尤为如此。<b>建筑存满，不再生产。</b>这并不总是问题，毕竟建筑存储已满意味着拥有大量库存，只不过通常而言，保持持续生产更好。<br><br>通过仓库是一种调节方式。当你建造完成一座仓库，你将获得一份当前已发现的所有产物的名单，你可以设定仓库调用任意数量的任何产出，前提是所有产出的总量在仓库的调用范围内，而这一范围基于仓库等级与存储乘数。<br><br>设定一座仓库的简单方法，那就是勾选你想运入仓库的每种产出，然后使用“在选定对象中重新分配”来均分运输量与限额。如果你希望建筑也能从仓库调用资源，那也请确保打开“低于限额仍输出”功能。",
   AdvisorStorageTitle: "存储与仓库",
   AdvisorTraditionContent: "一些奇观（恰高·占比尔、卢克索神庙、大本钟）提供一组新的选项，使你可以定制你的重生之路。每座奇观允许你进行一次四选一，以此来选择文明的传统、宗教以及意识形态。<br><br>一旦你选择了其中一项，在重生前都将不能更改，但你可以在未来的重生后选择其它选项。选定后，每座奇观都将能在提供必要资源后进行多次升级。每阶的加成是累计的，所以 1 阶 X 获得 +1 生产乘数以及 2 阶 X 获得 +1 生产乘数意味着在 2 阶对于 X 你将有总计 +2 生产乘数。",
   AdvisorTraditionTitle: "具有选择与升级的奇观",
   AdvisorWonderContent: "奇观是特殊建筑，它们可以提供全局效果，这将在你的游戏中产生深远影响。除了它们列出的功能，所有奇观还都能提供 +1 幸福感。你需要深思熟虑，因为<b>建造奇观需要大量资源，并且其建造者能力也高于正常水平。</b>这意味着它们可以轻易耗尽你库存中的需求资源，使得你的其它建筑缺少原料。<b>你可以自由设定每种资源是否运输</b>，这使你可以在你的库存资源能确保一切运转的状态下建造奇观。",
   AdvisorWonderTitle: "世界奇观",
   AdvisorWorkerContent: "建筑每次生产、运输资源都需要劳动者。如果你的可获劳动者不够，一些建筑将会暂停。对此而言，最显著的解决方法就是增加你的劳动者总数，通过建造、升级生产劳动者的建筑（小棚屋/房屋/公寓/住宅楼）。<br><br><b>但请注意，升级中的建筑是关闭状态，并且不提供任何资源，这也包括劳动者，所以也许你更偏向同时只升级一座住宅类建筑。</b>对于游戏早期，一个较好的目标是保持 70% 的忙碌劳动者。如果高于 70% 的忙碌劳动者占比，升级/建造住宅类建筑；如果低于 70% 的忙碌劳动者占比，扩大生产。",
   ...
   AkademikLomonosovDescV2: "该奇观可被升级，每一级提供 100 KW 电能。为周围 2 地块范围提供电力。该奇观可被移动",
   AkbarTheGreat: "阿克巴大帝",
   ...
   Alloy: "合金",
   AllTransportsWithDistance3TileAreImmediate: "所有运输距离小于或等于 3 地块范围，运输资源不需要劳动者且运输是即时（无运输单位运输）",
   Ally: "盟友",
   AlpineLogistics: "阿尔卑斯物流",
   Alps: "阿尔卑斯山",
   ...
   AngkorWat: "吴哥窟",
   AngkorWatDesc: "与该奇观相邻的建筑，获得 +1 劳动者能力乘数（建造者能力、单位劳动者生产能力以及单位劳动者运输能力）。该奇观额外提供 1000 名劳动者",
   AntiCheatFailure: "你的账户等级已受限。因为<b>未能通过反作弊</b>检查。若想就此进行申诉，请联系开发者",
   AntonieVanLeeuwenhoek: "安东尼·凡·列文虎克",
   ...
   Archimedes: "阿基米德",
   Architecture: "建筑学",
   AreYouSureYouWantToRebirthAsX: "你确定重生到 %{city} ？",
   ...
   Assembly: "装配",
   Astronomy: "天文学",
   AtlasMountains: "阿特拉斯山脉",
   AtlasMountainsDesc: "周围 2 地块范围内的所有建筑获得 +N 生产乘数。 N 为该奇观范围内建筑生产但未被范围内建筑消耗的不相同资源种类",
   AtomicBomb: "原子弹",
   AtomicFacility: "原子设施",
   AtomicTheory: "原子理论",
   Atomium: "原子塔",
   AtomiumDescV2: "周围 2 地块范围内所有产出科学的建筑，获得 +5 生产乘数。其产生的科学，等同于周围 2 地块范围内的科学总产出量（包括产出科学的奇观，例如：牛津大学。一次性生成的科学除外）。建造完成时，一次性生成一批科学，生成量等同于已解锁最昂贵科技所需",
   AuroraBorealis: "北极光",
   AuroraBorealisDesc: "周围 2 地块范围内的所有建筑（产出劳动者建筑除外）获得 +N 生产乘数。N 是基于发现后奇观持续时间",
   Australian: "澳大利亚",
   AustralianUniqueEffectHTML: "随机一个来自其他文明的<b>自然奇观</b>将会出现在地图上",
   Autocracy: "专制",
   AvailableIdeaPoints: "可用理念点数",
   Aviation: "航空",
   Babylonian: "巴比伦",
   BackToCity: "返回城市",
   BackupRecovery: "备份恢复",
   ...
   BastilleDay: "国庆日：蓬皮杜国家艺术和文化中心和凯旋门提供双倍加成效果。圣米歇尔山产出两倍文化。",
   BatchModeTooltip: "目前已选中 %{count} 建筑。将升级所有选中建筑",
   BatchSelectAllSameType: "所有相同建筑",
   BatchSelectAnyType1Tile: "相邻 1 格任何建筑",
   BatchSelectAnyType2Tile: "相邻 2 格任何建筑",
   BatchSelectAnyType3Tile: "相邻 3 格任何建筑",
   BatchSelectSameType1Tile: "相邻 1 格相同建筑",
   BatchSelectSameType2Tile: "相邻 2 格相同建筑",
   BatchSelectSameType3Tile: "相邻 3 格相同建筑",
   BatchSelectSameTypeSameLevel: "相同等级相同建筑",
   ...
   Blacksmith: "工匠铺",
   Blockchain: "区块链",
   BlockXCurrentGameSession: "屏蔽 %{name} (重进游戏后失效)",
   BlockXCurrentGameSessionDesc: "确定屏蔽 <b>%{name}</b> 该玩家？该屏蔽重进游戏后失效（自动重连除外）",
   BlueMosque: "蓝色清真寺",
   ...
   BranCastle: "布朗城堡",
   BranCastleDescV2: "该奇观产出的劳动者等同于周围 3 地块范围内的劳动者总产出。如果有足够的劳动者，还会将该奇观产出的劳动者转化为吸血鬼。吸血鬼不参与生产或运输资源，但被视为忙碌的劳动者。布郎城堡的等级由劳动者总数决定，每一级获得 +1 闲置劳动者科学产出和 +2 忙碌劳动者科学产出。该奇观仅可在万圣节（10月15日至11月15日）期间建造。",
   ...
   BritishMuseumDesc: "建造完成后，可以变更为其他文明的奇观（蓬皮杜国家艺术和文化中心、巨港、莫瑞泰斯皇家美术馆以及自然奇观除外。仅有一次变更机会，请慎重考虑）",
   ...
   BuildingLevel: "建筑等级",
   BuildingLevelBoost: "生产等级",
   BuildingLevelBoostDesc: "%{building} +%{value} 生产等级",
   BuildingLevelBoostFromElectrification: "现代化改造等级提供的生产等级",
   ...
   CarryOverWatchedResources: "继承重视资源提示设置",
   CarryOverWatchedResourcesIntoTheNextRunTheTabOnlyShowsAfterBuildingStatisticsOffice: "重视资源提示设置将继承到下轮游戏，该提示将在建造统计局后显示",
   CarryOverWatchedTradeableResources: "继承重视可交易资源提示设置",
   CarryOverWatchedTradeableResourcesIntoTheNextRunTheTabOnlyShowsAfterBuildingACaravansary: "重视可交易资源提示设置将继承到下轮游戏，该提示将在建造商队旅馆后显示",
   Carthage: "迦太基",
   Carthaginian: "迦太基",
   Cartographer: "制图师",
   CathedralOfBrasilia: "巴西利亚大教堂",
   CathedralOfBrasiliaDesc: "如果周围 2 地块范围的每个建筑形成一个完整的生产链，即范围内一个建筑生产的资源被范围内另一个建筑消耗（范围当中相同产出不同建筑也会被归入完整的生产链中），那么参入该完整的生产链中的每种建筑为其所有相同建筑提供 +X 生产乘数。X 为生产链中不相同建筑数量（最大值为18。奇观、旅馆、仓库、市集、克隆工厂和克隆实验室除外）",
   ...
   ChateauFrontenacDesc: "该奇观可被升级，每次升级时，将随机抽取三种当前时代的建筑。选择其中一种建筑来获得 +1 生产等级（一旦选择了就不能改变）",
   ...
   Church: "教堂",
   ChurchOfCarthage: "迦太基教会",
   CircusMaximus: "马克西穆斯角斗场",
   CircusMaximusDescV3: "每一级提供 +5 幸福感。每一级为所有音乐家协会、作家协会和画家协会提供 +1 生产和存储乘数",
   CityState: "城邦国家",
   CityViewMap: "城市",
   CivGPT: "CivGPT（人工智能）",
   CivIdle: "放置文明",
   ...
   ClassicalAge: "古典时代",
   ClearAfterUpdate: "在市集更新后，清除所有交易",
   ClearSelected: "清除选中",
   ClearSelection: "取消选择",
   ClearTransportPlanCache: "清除运输方案缓存",
   Cleopatra: "克利奥帕特拉",
   ClickToUnlockThisIdea: "点击以解锁此理念",
   CloneFactory: "克隆工厂",
   ...
   ColorTurquoise: "宝石绿",
   Colosseum: "斗兽场",
   ColosseumDescV3: "所有战车工坊免去 -1 幸福感。每一级消耗 10 战车并产出 5 幸福感。每个已解锁的时代提供等同于奇观等级的幸福感",
   ...
   CommunismLevel5DescHTML: "诞生一位<b>冷战时期</b>伟人。每进入一个新时代时，诞生<b>2 位额外</b>当前时代伟人",
   ...
   ConstructionBuilderMultiplierFull: "通用建造者能力乘数",
   ...
   Cosmodrome: "航天器发射场",
   CothonDockyards: "巨港造船厂",
   CothonOfCarthage: "巨港",
   CothonOfCarthageDesc: "解锁迦太基文明理念",
   CothonOfCarthageLevel: "巨港等级",
   Cotton: "棉花",
   CottonMill: "纺织厂",
   ...
   DefaultStockpileMax: "默认最大库存（建议初次新手最多设置为 50x ）",
   DefaultStockpileSettings: "默认库存输入系数（建议初次新手最多设置为 10x ）",
   ...
   DinosaurProvincialParkDesc: "该奇观可手动进行激活，获得一批💵瑞士货币。（仅可激活一次，价值等同于当前帝国总价值的 %{percent} ）",
   DinosaurProvincialParkNotUsedWarningHTML: "您尚未激活 <b>恐龙省立公园</b> ，请您在重生前进行激活，以免造成不必要的损失",
   Diplomacy: "外交",
   Display3PaintingsByJohannesVermeerToUnlock1ProductionMultiplier: "展览 3 幅 约翰内斯·维米尔 的画作获得 +1 生产乘数",
   Display3PaintingsByRembrandtVanRijnToUnlock1ProductionMultiplier: "展览 3 幅 伦勃朗·哈尔曼松·凡·莱因 的画作获得 +1 生产乘数",
   Display3PaintingsByVincentVanGoghToUnlock1ProductionMultiplier: "展览 3 幅 文森特·威廉·梵高 的画作获得 +1 生产乘数",
   Display5MasterpiecesToUnlock1BuildingLevelBoost: "展览 5 幅杰作获得 +1 生产等级",
   DisplayPaintingsBy5DifferentPaintersToUnlock1BuildingLevelBoost: "展览 5 位不同画家的画作获得 +1 生产等级",
   DisplayPaintingsWith5DifferentThemesToUnlock1BuildingLevelBoost: "展览 5 种不同主题的画作获得 +1 生产等级",
   DistanceInfinity: "无限制",
   DistanceInTiles: "距离（地块）",
   DiversificationBonus: "展览多元化奖励",
   DiwaliV3: "排灯节：恒河的范围增加至周围 2 地块范围。红堡的范围增加至周围 5 地块范围。桑奇大塔周围扩大 2 地块范围",
   ...
   EachLevelOfCothonOfCarthageProvides1IdeaPoint: "巨港每一级提供 1 理念点数",
   EachPairOfAdjacentPaintingsByTheSamePainterV2: "每相邻相同画家的画作获得 +0.5 生产等级",
   EachPairOfAdjacentPaintingsOfTheSameSizeV2: "每相邻相同尺寸的画作获得 +0.5 生产乘数",
   EachPairOfAdjacentPaintingsPaintedInTheSameCenturyV3: "每相邻同一世纪（100 年）内画作获得 +2 闲置劳动者科学产出",
   EachPairOfAdjacentPaintingsWithTheSameTheme: "每相邻相同主题的画作获得 +5 建造者能力乘数",
   EasterBunny: "复活节兔子",
   EasterBunnyConstructed: "已建造复活节兔子",
   EasterBunnyDesc: "建造完成后，重生时将复制 10％ 的额外伟人，并在下轮游玩中建造完成复活节兔子时根据当前已解锁时代诞生之前复制的额外伟人，诞生为此生伟人。该奇观仅可在四月建造",
   EastIndiaCompany: "东印度公司",
   EastIndiaCompanyDescV2: "当您通过与玩家贸易获得的所有物品都会获得相应贸易点数（包括税收，物品的每 1 价值 = 1 贸易点数）。该奇观累积您获得的贸易点数。每周期自动消耗 2000 贸易点数，使所有建筑每相邻一个运转的商队旅馆获得 +0.5 生产乘数。该奇观可消耗贸易点数进行升级，并且每一次额外升级获得 +0.5 生产乘数",
   Education: "教育学",
   ...
   ElbphilharmonieDesc: "周围 3 地块范围内的所有建筑，A 建筑每相邻不同于 A 建筑的阶且运转的建筑，则 A 建筑获得 +1 生产乘数（例：伐木场( I 阶)相邻 3 个砖窑( II 阶)，则伐木场获得 +3 生产乘数）",
   Electricity: "电能",
   ...
   EuphratesRiverDesc: "从事生产（非运输）的忙碌劳动者占比每有 10% ，为之前时代的所有已解锁建筑（产出劳动者建筑除外），提供 +1 生产乘数（每个时代的加成上限如下：石器至铁器为1，古典至中世纪为2,文艺复兴至工业为3，世界大战至冷战为4，信息为5）。当空中花园在其旁建造完成，基于空中花园解锁后的每个时代，使空中花园获得 +1 效果。当此奇观被发现时，与该奇观相邻无沉积资源的地块生成水资源",
   Every5WindMillsLevelGives1ProductionMultiplierToAdjacentPowerPlants: "每 5 级风力发电机为相邻的发电厂提供 +1 生产乘数",
   ExarchateOfAfrica: "非洲行省",
   ...
   FestivalTechV2: "解锁节日——正向幸福感（最大值为 50 ）可同时产出节日点数，1 幸福= 1 节日点数（开启节日时不获得节日点数）。每有 %{point} 节日点数，你的帝国可以开启一个周期的节日，节日将授予具有地区特色的独特加成",
   Feudalism: "封建主义",
   Fibonacci: "斐波那契",
   ...
   FindPlayers: "搜索玩家(支持模糊搜索)",
   Fire: "火",
   Firearm: "火器",
   FirstTimeGuideIntroHTML: "《放置文明》是一款<b>增量式4X /帝国建设</b>游戏——教程将帮助你完成第一次运行。但在开始之前，这里有一些快速设置。你应该输入你的<b>玩家昵称</b>（请避免使用不友好昵称），这样其他玩家就能认出你<b>（玩家交流QQ群：907371958）</b>",
   FirstTimeGuideNext: "下一步",
   FirstTimeTutorialWelcome: "欢迎来到放置文明",
   FirstTimeTutorialWelcome1HTML: "欢迎来到放置文明游戏。在本游戏中，你将运营属于你的帝国：<b>管理生产，解锁科技，与其他玩家开展资源贸易，获得伟人以及建造世界奇观</b>。<br><br>拖动鼠标进行移动。使用滚轮放大或缩小。单击一块空白地块以建造新建筑，单击一座建筑以查看它的详情。<br><br>诸如采石场与伐木场的一些建筑，需要建在资源地块上。开发者建议：将一座小棚屋（它可以提供劳动者）放置于迷雾边——建筑完成建造通常需要一些时间。在建造完成后，它将驱散其周围的迷雾。",
   FirstTimeTutorialWelcome2HTML: "建筑可以进行升级——这需要花费资源以及一些时间。当一座建筑处于升级中的状态，<b>它将不再生产</b>。这包括了生产劳动者的建筑，<b>所以永远不要同时升级你的所有建筑！</b><br><br>随着你帝国的发展，你将获得更多科学并以此解锁新的科技。当我们到那儿时，开发者将告诉你更多相关信息，但你可以前往“视图”→“研究”快速查看一下。<br><br>",
   ...
   Gallery: "美术馆",
   GalleryPainterFransHals: "弗朗斯·哈尔斯",
   GalleryPainterGeorgeHendrikBreitner: "乔治·亨德里克·布莱特纳",
   GalleryPainterJacobVanRuisdael: "雅各布·凡·雷斯达尔",
   GalleryPainterJanSteen: "扬·斯丁",
   GalleryPainterJohannesVermeer: "约翰内斯·维米尔",
   GalleryPainterKarelAppel: "卡雷尔·阿佩尔",
   GalleryPainterPieterBruegelTheElder: "彼得·勃鲁盖尔",
   GalleryPainterPieterDeHooch: "彼得·德·霍赫",
   GalleryPainterPietMondrian: "皮特·蒙德里安",
   GalleryPainterRachelRuysch: "雷切尔·勒伊斯",
   GalleryPainterRembrandtVanRijn: "伦勃朗·哈尔曼松·凡·莱因",
   GalleryPainterVincentVanGogh: "文森特·威廉·梵高",
   GalleryPaintingAMothersDuty: "《母亲的职责》",
   GalleryPaintingBroadwayBoogieWoogie: "《百老汇的布吉·伍吉》",
   GalleryPaintingCafeTerraceAtNight: "《夜间的露天咖啡座》",
   GalleryPaintingCompositionWithRedBlueAndYellow: "《红蓝黄的构图》",
   GalleryPaintingGirlInAWhiteKimono: "《穿白色和服的女孩》",
   GalleryPaintingGirlWithAPearlEarring: "《戴珍珠耳环的少女》",
   GalleryPaintingGrayTree: "《灰色的树》",
   GalleryPaintingSelfPortrait1889: "《自画像》",
   GalleryPaintingStillLifeWithFlowersOnAMarbleSlab: "《大理石板上的花卉静物画》",
   GalleryPaintingSunflowers: "《向日葵》",
   GalleryPaintingTheAnatomyLessonOfDrNicolaesTulp: "《尼古拉斯·杜尔博士的解剖学课》",
   GalleryPaintingTheArtOfPainting: "《绘画的艺术》",
   GalleryPaintingTheBanquetOfTheOfficersOfTheStGeorgeMilitiaCompany: "《圣乔治市民警卫队官员之宴》",
   GalleryPaintingTheCourtyardOfAHouseInDelft: "《代尔夫特一所房子的庭院》",
   GalleryPaintingTheCryingCrocodileTriesToCatchTheSun: "《哭泣的鳄鱼试图抓住太阳》",
   GalleryPaintingTheFeastOfSaintNicholas: "《圣尼古拉斯的盛宴》",
   GalleryPaintingTheHuntersInTheSnow: "《雪中猎人》",
   GalleryPaintingTheJewishBride: "《犹太新娘》",
   GalleryPaintingTheLaughingCavalier: "《微笑的骑士》",
   GalleryPaintingTheLittleStreet: "《小街》",
   GalleryPaintingTheMerryFamily: "《欢乐家庭》",
   GalleryPaintingTheMilkmaid: "《挤奶女工》",
   GalleryPaintingTheNightWatch: "《夜巡》",
   GalleryPaintingThePotatoEaters: "《吃马铃薯的人》",
   GalleryPaintingTheSingelBridgeAtThePaleisstraatInAmsterdam: "《阿姆斯特丹皇宫街的辛格尔桥》",
   GalleryPaintingTheStarryNight: "《星夜》",
   GalleryPaintingViewOfHaarlemWithBleachingFields: "《带有漂白场的哈勒姆风景画》",
   GalleryPaintingWheatFieldWithCrows: "《麦田上的鸦群》",
   GalleryPaintingWindmillAtWijkBijDuurstede: "《埃克河边的磨坊》",
   GalleryPaintingWomanHoldingABalance: "《保持平衡的女人》",
   GalleryThemeAbstract: "抽象画",
   GalleryThemeDomesticScene: "家庭情景画",
   GalleryThemeLandscapeCityscape: "风景画",
   GalleryThemePortrait: "肖像画",
   GalleryThemeStillLife: "静物画",
   GameCalendar: "游戏日历",
   Gameplay: "游戏设置",
   GangesRiver: "恒河",
   GangesRiverDescV3: "周围 1 地块范围内的每种建筑（产出劳动者建筑除外），每种建筑所有相同建筑获得 +N 生产乘数，N 为解锁该建筑时代的时代智慧等级",
   Garment: "服装",
   ...
   Generate1hTimeWarpWhenEnteringANewAge: "每进入一个新时代时，获得 1 小时扭曲时间（不会超出扭曲时间存储上限）",
   GenerateOneTimeKotiEqualToXOfTheTotalBuildingValue: "一次性获得一批💵瑞士货币。（价值等同于当前建筑物总价值的 %{percent} ）",
   GenerateOneTimeKotiEqualToXOfTheTotalEmpireValue: "一次性获得一批💵瑞士货币。（价值等同于当前帝国总价值的 %{percent} ）",
   GenerateOneTimeScienceEqualToTheCheapestTechnologyOfTheCurrentAge: "生成一批科学，生成量等同于当前时代最廉价科技所需",
   GenerateOneTimeScienceEqualToTheCostOfTheMostExpensiveTechnologyOfTheCurrentAge: "生成一批科学，生成量等同于当前时代最昂贵科技所需",
   Genetics: "遗传学",
   GenghisKhan: "成吉思汗",
   ...
   GoldenPavilion: "金阁寺",
   GoldenPavilionDesc: "周围 3 地块范围内的所有建筑，A 建筑相邻 B 建筑，且 B 生产是 A 消耗任意所需，则 A 建筑获得 +1 生产乘数（克隆实验室与克隆工厂除外,需建筑都运转。例：石雕铺相邻 3 个工匠铺，则石雕铺获得 +3 生产乘数）",
   GoldMiningCamp: "金矿",
   GordonMoore: "戈登·摩尔",
   GranaryAdministration: "粮仓管理",
   GrandBazaar: "大巴扎",
   GrandBazaarDesc: "该奇观可管理你的所有市集，与该奇观相邻的市集拥有不同的交易项。与该奇观相邻运转的商队旅馆，获得 +5 生产与存储乘数",
   GrandBazaarFilters: "筛选",
   GrandBazaarFilterWarningHTML: "必须先进行筛选，才能显示市集交易项",
   GrandBazaarFilterYouGet: "获得",
   GrandBazaarFilterYouPay: "出售",
   GrandBazaarSeach: "搜索",
   ...
   GreatPeopleShardsAcquired: "获得的伟人碎片",
   ...
   GreatSphinx: "狮身人面像",
   GreatSphinxDescV3: "为周围 1 块地范围内的所有建筑提供 +N 生产乘数（ N 为其相邻相同建筑数量）。该奇观可被升级，并且每一次额外升级为奇观周围扩大 1 地块范围。",
   GreatWall: "长城",
   GreatWallDescV2: "周围 1 地块范围内所有建筑，获得 +N 生产、劳动者能力以及存储乘数。 N 为当前科技时代与建筑所属时代之间的差值。该奇观可被升级，并且每一次额外升级为长城周围扩大 1 地块范围。当与紫禁城相邻时，则长城周围扩大 1 地块范围",
   ...
   Habitat67: "栖息地67住宅区",
   Habitat67DescV2: "该奇观可被升级，每一级为AI实验室提供 +1 生产、劳动者能力以及存储乘数。为AI实验室提供 +N 生产和存储乘数，N 为信息时代智慧等级。每有正向 5 幸福感（最大值为 50 ）为AI实验室提供 +1 生产等级",
   HafsidDynasty: "哈夫斯王朝",
   HagiaSophia: "圣索菲亚大教堂",
   ...
   Hannibal: "汉尼拔·巴卡",
   HannibalSStrategy: "汉尼拔的战略",
   HannoTheNavigator: "汉诺",
   Happiness: "幸福感",
   ...
   IberianColonies: "伊比利亚殖民地",
   IdeologyDescHTML: "<style>b { color: #0000ff; }</style>使用<b>鼠标滚轮或右边的滚动条</b>，从<b>自由主义、保守主义、社会主义以及共产主义</b>中<font color= #ff0000>选择一种</font>作为你的帝国意识形态。一旦选择，你将<b>不能更换意识形态</b>。每种意识形态，你都能解锁更多增强",
   IMPei: "贝聿铭",
   ...
   ItaipuDam: "伊泰普大坝",
   ItaipuDamDesc: "该奇观可被升级，并且每一次额外升级，为周围 2 地块范围的建筑提供 +1 生产乘数或 +1 生产等级（可自由分配每+1加成）。为周围 2 地块范围提供电力。",
   ...
   KeepersSpecialDay: "守护者的的特别日：%{names} (所有建筑获得 +1 生产乘数和 +1 生产等级)",
   KeepOurServerOnPackOptions: "守护者权益",
   KeepTheWindowOpenAfterPlacingTrade: "发出订单后保留此窗口",
   Keukenhof: "库肯霍夫公园",
   KeukenhofDescV2: "+N 幸福感。N 为周围 3 地块范围内的所有建筑生产或消耗的不相同资源种类",
   KingDavid: "大卫王",
   KizhiPogost: "基日乡村教堂",
   KizhiPogostDescV2: "周围 3 地块范围内的所有建筑获得 +N 生产乘数，N 为该奇观获得的生产乘数（生产乘数可来自：戴森球、蓬皮杜文艺中心、圣家族大教堂等通用加成奇观）",
   Knight: "骑士",
   KnightCamp: "骑士营地",
   KoningsdagV3: "国王节：库肯霍夫公园为范围内的所有建筑提供 +N 生产乘数，N 为库肯霍夫公园提供幸福感的 25% 。莫瑞泰斯皇家美术馆的展览画家作品奖励和展览多元化奖励提供双倍加成效果",
   Koti: "💵瑞士货币",
   KotiInStorage: "已存储",
   KotiProduction: "💵瑞士货币",
   Kremlin: "克里姆林宫",
   ...
   LakeLouise: "路易斯湖",
   LakeLouiseDesc: "贸易地图上所有相邻玩家都视为盟友（某些情况下仍会显示非盟友）。每位盟友的地块为对应建筑提供 +2 生产等级",
   LandTrade: "陆上贸易",
   Language: "语言",
   Laozi: "老子",
   Lapland: "拉普兰区",
   ...
   LiberalismLevel4DescHTML: "所有发电厂 +1 生产乘数",
   LiberalismLevel5DescHTMLV3: "所有可现代化改造的建筑获得<b> +5 生产等级</b>",
   ...
   Lumber: "木材",
   LumberMill: "锯木场",
   LunarNewYearV2: "农历新年：长城和黄鹤楼为范围内所有建筑提供等同于奇观提供生产乘数的生产等级。大报恩寺琉璃塔为所有此生伟人提供 +1 等级",
   LuxorTemple: "卢克索神庙",
   ...
   MarketRefreshMessage: " %{count} 座市集的交易已经更新",
   MarketSell: "交易",
   MarketSettings: "市集设定",
   ...
   Maslenitsa: "送冬节: 基日乡村教堂的范围增加至周围 6 地块范围。贝加尔湖的范围增加至周围 4 地块范围。罗蒙诺索夫院士号产出的电能双倍",
   Masonry: "砖石",
   Masterpiece: "杰作",
   MatrioshkaBrain: "套脑",
   ...
   MediterraneanTrades: "地中海贸易",
   MercenaryCommand: "雇佣兵指挥官",
   MerchantFleet: "商船舰队",
   Metallurgy: "冶金",
   ...
   MiddleClickDescHTML: "选取你要<b>复制蓝图的建筑</b>（包括建造中的）点击，别点击任何地块！直接<b>按鼠标中键</b>指着想要建设相同建筑的地块",
   Midsummer: "仲夏节",
   MidsummerDesc: "为周围 1 块地范围内的所有建筑提供 +N 生产等级，N 为该建筑获得时代智慧生产乘数的数值（奇观提供时代智慧加成除外）。该奇观可被升级，并且每一次额外升级为奇观周围扩大 1 地块范围。该奇观仅可在仲夏期间（6月10日至6月30日）建造。",
   MilitaryTactics: "军事战术",
   Milk: "奶",
   MinusXResearchCost: "-%{percent} 科学所需",
   MirrorServer: "镜像服务器",
   Miscellaneous: "杂项",
   MobileOverride: "移动端",
   MogaoCaves: "莫高窟",
   ...
   MoveTileConfirm: "你确定宣称该地块？ 你将失去所有贸易地块并且 %{time} 小时内无法再次宣称",
   Movie: "电影",
   MovieStudio: "电影制片厂",
   Museum: "博物馆",
   Music: "音乐",
   MusiciansGuild: "音乐家协会",
   MuteWhenBackgrounded: "后台静音",
   ...
   NextMarketUpdateIn: "下次市集更新剩余时间",
   NiagaraFalls: "尼亚加拉瀑布",
   NiagaraFallsDescV2: "当此奇观被发现后，所有仓库、市集以及商队旅馆，获得 +N 存储乘数，N 为已解锁时代数量。阿尔伯特·爱因斯坦每个等级为研究基金会提供 +1 生产乘数（包括时代智慧提供的等级，不受其他增强影响——比如百老汇）",
   NielsBohr: "尼尔斯·玻尔",
   ...
   NoKotiExport: "禁止对外输出💵瑞士货币",
   NoKotiExportDesc: "建筑将不能从瑞士银行中运输💵瑞士货币——他们仍然可以从其他非瑞士银行的建筑中运输💵瑞士货币",
   ...
   OnlyYouCanSeeThis: "该消息仅您可见",
   OnYourSpecialDayDesc: "在您的特别日里，所有玩家的所有建筑获得 +1 生产乘数和 +1 生产等级。你的特别日将会会显示在游戏日历上。<b>此效果每 %{cooldown} 天只能更改一次。</b>",
   OpenGallery: "打开画廊",
   ...
   OpetV3: "欧佩特：狮身人面像额外为范围内所有建筑，提供 +N 生产等级（ N 为其相邻相同建筑数量）",
   OpticalFiber: "光纤",
   ...
   OxfordUniversityDescV3: "其产生的科学，等于其它产出科学建筑总科学产出的 10% 。建造完成时，一次性生成一批科学，生成量等同于已解锁最昂贵科技所需",
   PabloPicasso: "巴勃罗·毕加索",
   Pagoda: "宝塔",
   Painter: "画家",
   PainterAdjacency: "画家相邻",
   PaintersCollectionBonus: "展览画家作品奖励",
   PaintersGuild: "画家协会",
   Painting: "绘画",
   PalmJumeirah: "朱美拉棕榈岛",
   ...
   ParliamentHill: "国会山",
   Parthenon: "帕特农神庙",
   ParthenonDescV3: "每一级诞生两位古典时代伟人，每位伟人有 4 项可选。所有音乐家协会与画家协会，获得 +1 生产、劳动者能力以及存储乘数，并免去 -1 幸福感",
   Passcode: "密码",
   ...
   Petra: "佩特拉",
   PetraDescV3: "解锁更多扭曲倍速和扭曲时间继承。该奇观可以升级，每一级提供 1 小时的扭曲存储。当你离线时生成扭曲时间，你可以用来加速你的帝国或携带最多 4 小时（14.4K）扭曲时间到重生后的文明（可在右上角的选项-游戏设置-离线生产栏里分配离线设置）",
   PetraOfflineTimeReconciliation: "与服务器脱机时间核准后，获得 %{count} 扭曲时间",
   Petrol: "汽油",
   PhiloFarnsworth: "菲洛·法恩斯沃斯",
   Philosophy: "哲学",
   PhoenicianAlphabet: "腓尼基字母表",
   Physics: "物理学",
   ...
   PlayerFlag: "玩家旗帜",
   PlayerHandle: "玩家信息",
   PlayerHandleColor: "昵称颜色",
   PlayerHandleFont: "昵称字体",
   ...
   PlayerTradeMaxTradeAmountFilter: "最大收购数量",
   ...
   Plus2ActiveTradesForKeeperOfOurServer: "守护者 +2 活跃中的订单上限",
   Plus2ActiveTradesForSupporter: "支持者 +2 活跃中的订单上限",
   Plus2RangeForBuildings: "%{buildings} 周围扩大 2 地块范围",
   PlusAtlasMountainsRange: "阿特拉斯山脉周围扩大 %{range} 地块范围",
   PlusXAgeWisdom: "%{age} 时代智慧获得 +%{percent} 加成效果",
   PlusXBaseStorageForMarketWarehouseAndCaravansary: "所有市集、商队旅馆以及仓库，获得 +%{percent} 基础存储能力",
   PlusXGreatPeopleFromTheCurrentAge: "诞生 %{count} 位当前时代伟人",
   ...
   PortOfSingaporeDesc: "所有市集、商队旅馆以及仓库，获得 +1 生产和存储乘数。该奇观可被升级，并且每一次额外升级为所有市集、商队旅馆以及仓库提供 +1 生产和存储乘数",
   Poseidon: "海神波塞冬",
   ...
   PublishingHouse: "出版社",
   PunicCoinage: "布匿货币",
   PunicGoldenAge: "布匿黄金时代",
   PunicLegalCodex: "布匿法律法典",
   PurpleDyeMonopoly: "紫色染料垄断",
   ...
   QinShiHuang: "秦始皇",
   QuickUiMode: "自动分配模式",
   QuickUiModeTooltip: "当选择或取消选择资源，根据所选资源全自动平均分配运输量和限额（包括升级后和发生乘数变化）",
   QutbMinar: "古特伯高塔",
   ...
   RebirthHistoryAll: "所有",
   RebirthHistoryEmpireValuePerCycle: "每周期帝国价值",
   RebirthHistoryEmpireValuePerWallSecond: "在线每秒帝国价值",
   RebirthHistoryEmpireValueV2: "帝国总价值",
   RebirthHistoryEmpty: "暂无重生记录",
   RebirthHistoryExtraGreatPeopleAtRebirth: "重生时的额外伟人",
   RebirthTime: "重生时间",
   Reborn: "重生",
   ...
   RedFort: "红堡",
   RedFortDesc: "周围 3 地块范围内的所有建筑获得 +1 生产等级。该奇观可被升级，并且每一次额外升级为周围 3 地块范围内的所有建筑提供 +1 生产等级",
   ...
   ReligionDescHTML: "<style>b { color: #0000ff; }</style>使用<b>鼠标滚轮或右边的滚动条</b>，从<b>基督教、伊斯兰教、佛教以及多神教</b>中<font color= #ff0000>选择一种</font>作为你的帝国宗教。一旦选择，你将<b>不能更换宗教</b>。每种宗教，你都能解锁更多增强",
   ReligionIslam: "伊斯兰教（推荐，新手首选）",
   ...
   ResearchLab: "研究实验室",
   ResearchMenu: "研究",
   ResearchSuperintelligence: "研究技术奇点",
   ResetLayout: "重置布局",
   Resource: "资源",
   ResourceAmount: "数量",
   ResourceBar: "资源栏",
   ...
   ResourceExportToSameType: "输出至相同建筑",
   ResourceExportToSameTypeTooltip: "允许其它相同建筑从此建筑运送资源",
   ...
   ResourceTransportPreference: "输入倾向",
   RestitutorDescHTML: "添加我即将推出的游戏到愿望清单中——<b>《光复者：帝国重铸》</b>。这是一款以历史为背景的渐进式大战略游戏，侧重于<i>治国之道、外交以及精心策划的战争</i>。游戏设定在公元 192 年康茂德去世后的罗马帝国时期，当时帝国分裂为相互对立的省份。作为总督，选择一个省份作为你的领地并努力恢复帝国。",
   RestitutorEmpireRestoredEarlyAccess: "《光复者：帝国重铸》特别加成",
   ...
   RoyalFlycatcherDesc: "周围 2 地块范围内的所有建筑获得 +X 生产等级。 X = 该奇观范围内空白地块数量",
   ...
   SagradaFamiliaDesc: "周围 2 地块范围内的所有建筑，获得 +N 生产、劳动者能力以及存储乘数。 N 为该奇观相邻建筑最大阶差（例：市集( I 阶)和议会( VI 阶)都相邻圣家族大教堂，则周围 2 地块范围内的所有建筑获得 +5 生产、劳动者能力以及存储乘数）",
   SaintBasilsCathedral: "瓦西里升天教堂",
   SaintBasilsCathedralDescV2: "允许资源开采建筑在资源点相邻地块运转。与该奇观相邻的 I 阶建筑，获得 +1 生产、劳动者能力以及存储乘数",
   Saladin: "萨拉丁",
   Samsuiluna: "萨姆苏·伊路那",
   SanchiStupa: "桑奇大塔",
   SanchiStupaDescV2: "周围 2 地块范围内所有建筑，对于范围内建筑 “输出” 与 “输入” 的资源调用，运输资源不需要劳动者且运输是即时（无运输单位运输）。该奇观可被升级，并且每一次额外升级为奇观周围扩大 1 地块范围。",
   Sand: "沙",
   Sandpit: "采沙坑",
   ...
   SatoshiNakamoto: "中本聪",
   SaturnaliaV2: "农神节：阿尔卑斯山额外为所有建筑每 10 等级，提供 +1 生产等级",
   Save: "保存",
   SaveAndClose: "保存并关闭",
   SaveAndExit: "保存并退出",
   School: "学校",
   Science: "科学",
   ScienceCarryingOver: "下轮游玩获得的科学",
   ...
   SelectAdaptiveGreatPeopleBoost: "未选择的建筑伟人提示",
   ...
   ServerBackup: "服务器备份",
   ServerBackupDescHTML: "您可以将您的 <b>永恒伟人</b> 和 <b>时代智慧</b> 备份到服务器，这是在你重生时自动完成的。当存档损坏且没有本地备份时，服务器备份可能很有用，恢复备份将强制重置本轮游玩会导致失去蓬皮杜文艺中心",
   SetAsDefault: "设为默认",
   ...
   ShortcutUpgradePageCancelAllUpgrades: "取消所有相同建筑升级",
   ...
   SourceGreatPersonBirthday: "🎂诞辰🎂（伟人）: %{person}",
   SourceGreatPersonPermanent: "永恒伟人：%{person}",
   SourceGreatPersonPermanentBirthday: "🎂诞辰🎂（永恒伟人）: %{person}",
   ...
   SpaceProgram: "太空计划",
   SpecialDay: "特别日",
   SpecialDayEffectDesc: "所有建筑获得 +1 生产乘数和 +1 生产等级",
   Spinner: "运转动画",
   SpinnerSpeed: "运转动画速度",
   SpinnerSpeedDescHTML: "调整运转动画的速度，作为区分现代化改造的建筑运转动画速度为两倍。<b>调整值必须位于0.01到100之间。默认值为1</b>（调整运转动画的速度不会影响每周期生产）",
   Sports: "体育运动",
   Sputnik1: "伴侣号",
   Sputnik1DescV3: "该奇观可被升级，每一级为所有冷战时代的伟人（包括未拥有过的）提供 +1 等级的本轮效果（不包括奇观伟人）。每一级为航天器发射场提供 +1 生产和存储乘数。为航天器发射场提供 +N 生产和存储乘数，N 为冷战时代智慧等级。",
   Stable: "马厩",
   Stadium: "体育场",
   StartFestival: "欢度佳节吧！",
   Stateship: "国家状态",
   ...
   StatueOfLibertyDesc: "与该奇观相邻建筑，获得 +N 生产、劳动者能力以及存储乘数。 N 为被加成建筑其相邻相同建筑数量（例：相邻自由女神像的A建筑，A建筑相邻 3 个相同建筑，则A建筑获得 +3 生产、劳动者能力以及存储乘数）",
   StatueOfZeus: "宙斯神像",
   StatueOfZeusDescV2: "与该奇观相邻无沉积的地块，随机生成并显露沉积资源（根据已解锁资源去随机，每种各一个不重复）。为周围 1 块地范围内的所有建筑提供 +5 生产与存储乘数。该奇观可被升级，并且每一次额外升级为奇观周围扩大 1 地块范围。",
   ...
   SuperintelligenceDescV3: "建造该奇观后，可花费 38.75 Qa 科学研究技术奇点使重生后的文明获得 3.875 Qa 科学（足以解锁所有科技，激活后重生后的文明将无法获得未来相关成就）",
   SuperintelligenceRebirthWarning: "您已建造 <b>技术奇点</b> 尚未研究<b>激活技术奇点</b>——重生后的文明将无法获得 <b>3.875 Qa</b> 科学",
   SupporterPack: "支持者包",
   ...
   Surplus: "净值",
   SwissBank: "瑞士银行",
   SwissBankDescV3: "从所有可与玩家交易的资源（旅馆存储或与旅馆相邻的仓库存储）中选择一种资源转换为💵瑞士货币。每个周期基础产出1个💵瑞士货币（可被生产乘数影响），该奇观可被升级，并且每一次额外升级增加 1 基础产出（无论基础产出提升还是生产乘数提升都只是提升每周期等价兑换最大总数量）。瑞士银行可以存储无限量的💵瑞士货币",
   Sword: "剑",
   SwordForge: "铸剑铺",
   ...
   TechResourceTransportPreference: "解锁建筑输入倾向————允许设定建筑如何运送其生产所需资源。",
   ...
   TempleOfHeaven: "天坛",
   TempleOfHeavenDesc: "所有等级 10 及以上建筑，获得 +1 劳动者能力乘数（建造者能力、单位劳动者生产能力以及单位劳动者运输能力）",
   TempleOfPtah: "卜塔神庙",
   TerracottaArmy: "兵马俑",
   ...
   Today: "今日",
   TodayIsTheBirthdayOfX: "今天是 %{name} 的诞辰——此生伟人与永恒伟人的效果翻倍！",
   TodoTabs: "待处理提示",
   ...
   TowerOfBabel: "巴别塔",
   TowerOfBabelDesc: "可为与该奇观相邻的建筑所有相同建筑提供 +2 生产乘数（多次相邻不可叠加），需满足相同建筑中至少有一座运转中建筑与奇观相邻",
   ...
   TraditionDescHTML: "<style>b { color: #0000ff; }</style>使用<b>鼠标滚轮或右边的滚动条</b>，从<b>教化、商业、扩张以及荣耀</b>中<font color= #ff0000>选择一种</font>作为你的帝国传统。一旦选择，你将<b>不能更换传统</b>。每种传统，你都能解锁更多增强",
   ...
   TribuneUpgradeDescV4: "您作为保民官，您能体验完整版的单机内容，但是在线内容会受到一定的限制（例如：每分钟最大交易价值限制为 10K、贸易地块加成数量与重置永恒伟人等功能），只有提升账号等级才能体验完整的在线内容。为了保护游戏公平性，从当前账号等级<b>保民官</b>升至<b>财务官</b>时的时候，你的每个永恒伟人保留的等级有一定的限制：<ul><li>青铜至古典时代最多可保留到等级 <b>3</b> </li><li>中世纪至工业时代最多可保留到等级 <b>2</b> </li><li>世界大战至信息时代最多可保留到等级 <b>1</b> </li></ul>超过等级限制部分的伟人碎片和<b>所有时代智慧</b>的等级都将<b>不能保留</b>。<b>这是一项反机器人措施，旨在让每个人都可以免费玩游戏。</b>",
   ...
   TutorialBuildWheatFarmHTML: "要快速建造大量的建筑，你可以<b>选择一个建筑地块</b>，别点击任何地块！直接<b>按鼠标中键</b>指着想要建设相同建筑的地块——这将自动复制选定的建筑到空白地块上。",
   TutorialBuildX: "建造 %{building} （教程，玩家交流QQ群：907371958）",
   TutorialBuildXBuildings: "建造 %{count} %{building} （教程，玩家交流QQ群：907371958）",
   ...
   UNGeneralAssemblyCurrent: "本周生效联合国大会 #%{id} 决议效果",
   UNGeneralAssemblyNext: "下周生效联合国大会 #%{id} 决议效果",
   UNGeneralAssemblyVoteEndIn: "结束前可以随时更改投票。投票结束剩余时间：<b>%{time}</b>",
   UniqueBuildings: "独特建筑",
   UniqueEffects: "独特的效果",
   UniquePermanentGreatPeople: "生效永恒伟人种类",
   ...
   View: "查看",
   ViewMenu: "视图",
   ViewOnWikipedia: "查看 %{name} 的维基百科",
   ViewTechnology: "查看",
   VincentVanGogh: "文森特·威廉·梵高",
   VirtualReality: "虚拟现实",
   Voltaire: "伏尔泰",
   WallOfBabylon: "巴比伦城墙",
   WallOfBabylonDesc: "所有建筑获得 +N 存储乘数，每个时代提供的 N 值如下：（铁器为1，古典至中世纪为2,文艺复兴至工业为3，世界大战至冷战为4，信息为5）",
   WallStreet: "华尔街",
   WallStreetDesc: "周围 2 地块范围内，所有产出硬币、钞票、债券、股票以及外汇的建筑，获得 +N 生产乘数。N 为 1 至 5 的随机值，每座受加成建筑单独取值，并且该值随每次市集更新而改变。约翰·D·洛克菲勒效果翻倍（此生伟人与永恒伟人的效果翻倍。时代智慧除外）",
   WaltDisney: "华特·迪士尼",
   Warehouse: "仓库",
   ...
   WatchedTradeableResources: "重视可交易资源提示",
   Water: "水",
   ...
   WindTurbine: "风力发电机",
   WinterCarnival: "冬季嘉年华：北极光的范围增加至周围 4 地块范围。弗朗特纳克城堡和栖息地67住宅区提供生产等级翻倍",
   WishlistRestitutor: "《光复者：帝国重铸》愿望单",
   ...
   WorldTradeOrganizationDesc: "该奇观可被升级，每一级为拥有的贸易地块加成额外提供 +1 生产乘数（相同地块同样生效，不包括相邻玩家加成）。参加每周世界贸易组织大会，在世界贸易组织大会上获选的建筑将增加在贸易地图上的数量",
   WorldWarAge: "世界大战",
   WorldWideWeb: "万维网",
   WritersGuild: "作家协会",
   Writing: "写作",
   WTOVoteCurrent: "本周生效世界贸易组织大会 #%{id} 投票效果",
   WTOVoteDescriptionHTML: "在世界贸易组织大会上获选的建筑将增加在<b>贸易地图上的数量</b>",
   WTOVoteNext: "下周生效世界贸易组织大会 #%{id} 投票效果",
   WuZetian: "女皇武则天",
   WuZetianDesc: "+%{value} 运输能力乘数（减少运输所需劳动者）",
   XBaseStorageForWarehouseAndCaravansary: "所有市集、商队旅馆以及仓库，获得 +%{percent} 基础存储能力",
   XBuildingsWillBeBuilt: "%{count} 个建筑将被建造",
   XDifferentMasterpieces: "%{count} 幅不同杰作",
   XDifferentPainters: "%{count} 位不同画家",
   XDifferentThemes: "%{count} 种不同主题",
   XhWarpStorageThisRun: "本轮增加 %{hour} 小时扭曲存储",
   XPaintingsBy: "%{count} 幅 %{painter} 的画作",
   XResourceHasBeenDestroyed: "已销毁 <b>%{amount} %{resource}</b>",
   XRunsInTotal: "累计 %{count} 次重生",
   XSpecialDay: "%{name} 的特别日",
   Xuanzang: "玄奘",
   YangtzeRiver: "长江",
   ...
   YouHaveAdaptiveGreatPeopleWithBoostToSelect: "您拥有的建筑伟人未选择相应建筑，点击此提示选择它们",
   YuriGagarin: "尤里·加加林",
