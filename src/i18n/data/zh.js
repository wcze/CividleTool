const ZH_CN = {
   ...
   AtlasMountainsDesc: "周围 2 地块范围内的所有建筑获得 +N 生产乘数。 N 为该奇观范围内建筑��产但未被范围内建筑消耗的不相同资源种类",
   AtomicBomb: "原子弹",
   AtomicFacility: "原子设施",
   AtomicTheory: "原子理论",
   Atomium: "原子塔",
   ...
   BigBen: "大本钟",
   BigBenDesc: "+2 忙碌劳动者科学产出。选取一种帝���意识形态，每条选项都将解锁更多增强",
   Binnenhof: "内院",
   Biplane: "双翼飞机",
   ...
   BranCastle: "布朗城堡",
   BranCastleDescV2: "该奇观产出的劳动者等同于周围 3 ��块范围内的劳动者总产出。如果有足够的劳动者，还会将该奇观产出的劳动者转化为吸血鬼。吸血鬼不参与生产或运输资源，但被视为忙碌的劳动者。布郎城堡的等级由劳动者总数决定，每一级获得 +1 闲置劳动者科学产出和 +2 忙碌劳动者科学产出。该奇观仅可在万圣节（10月15日至11月15日）期间建造。",
   ...
   BroadwayDesc: "诞生一位当前时代伟人与一位上时代伟人。选择一位伟人使其效��翻倍，可随时变更效果翻倍的伟人（此生伟人与永恒伟人的效果翻倍。时代智慧除外）",
   BronzeAge: "青铜时代",
   BronzeTech: "青铜",
   ...
   CentrePompidouDesc: "建造完成后，所有建筑获得 +1 生产乘数和 +2 存储乘数。对于每次游玩该奇观未记录的文明达到信息时代后，在重生时记录重生前的文明，每拥有一个记录在册的文明额外提供 +1 生产乘数和 +2 存储乘数。该奇观的价值不计入帝国的总价值中。如果当前的游玩达到信息时代，下一次游玩的文明与当前是不同的，那么该奇观可被继承！",
   ...
   CNTower: "加拿大国家电视塔",
   CNTowerDesc: "所��电影制片厂、广播站以及电视台，免去 -1 幸福感。所有世界大战与冷战时代的解锁建筑，获得 +N 生产、劳动者能力以及存储乘数。 N 为建筑自身时代与阶之差",
   Coal: "煤",
   CoalMine: "煤矿",
   CoalPowerPlant: "燃煤电厂",
   Coin: "硬币",
   ...
   ColorTurquoise: "宝石绿",
   Colosseum: "斗兽场",
   ColosseumDescV3: "所有战车工坊免去 -1 幸福感。每一级消耗 10 战车并产出 5 幸福感。每个已解锁的时代提供等同于奇观等级的幸��感",
   ...
   ReligionDescHTML: "使用<b>鼠标滚轮或右边的滚动条</b>，从<b>基督教、伊斯兰教、佛教以及多神教</b>中选择一种作为你���帝国宗教。一旦选择，你将<b>不能更换宗教</b>。每种宗教，你都能解锁更多增强",
   ...
   Year: "年份",
   YearOfTheSnakeDesc: "建造完成后，进入一个新时代时，由每一个已解锁时代获取一位伟人改为获取相同数量的当前时代伟人。周围 2 地块范围内的所有建筑，获得 +1 生产乘数。该奇观可被升级，并且每一次额外升级为周围 2 地块范围内的所有建筑提供 +1 生产乘数。该奇观仅可在农历新年期间（2月10日至2月24日）建造",
