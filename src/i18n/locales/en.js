export default {
  ...
  about: {
    ...
    querySourceFiles: 'View Data Files',
  ...
  sourceFiles: {
    generatedNote: 'JSON files are generated by this project from game source data.',
    repositoryNote: 'Source links point to the main branch of the official CivIdle GitHub repository:'
  },
  home: {
  ...
  calcBuildings: {
    ...
    searchPlaceholder: 'Search building...',
      buildingTypeFilter: 'Building type filter',
      ageFilter: 'Age filter',
      allTypes: 'All Types',
      ordinaryBuilding: 'Buildings',
      allAges: 'All Ages',
    ...
    buildingOutput: 'Building Output',
    ...
    exclusiveCivilization: 'Exclusive Civilization',
