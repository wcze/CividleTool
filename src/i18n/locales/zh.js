export default {
  ...
  calcBuildings: {
    ...
    searchPlaceholder: '搜索建筑...',
      buildingTypeFilter: '建筑类型筛选',
      ageFilter: '时代筛选',
      allTypes: '全部类型',
      ordinaryBuilding: '普通建筑',
      allAges: '全部时代',
    ...
    consumptionPerHour: '每小时',
    consumptionPer4Hours: '每4小时',
    consumptionPer12Hours: '每12小时',
    consumptionPerDay: '每天',
    consumptionPer2Days: '每2天',
    consumptionPer3Days: '每3天',
    viewDetails: '查看详情',
    hideDetails: '收起详情',
    detailCurrent: '当前',
    detailTarget: '目标',
